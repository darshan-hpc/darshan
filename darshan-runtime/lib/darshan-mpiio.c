...
#endif
{
    ...
    tm1 = darshan_core_wtime();
    ret = __real_MPI_File_iwrite(fh, buf, count, datatype, request);
    tm2 = darshan_core_wtime();
...
DARSHAN_PMPI_MAP(MPI_File_iread_at, int, (MPI_File fh, MPI_Offset offset, void * buf,
    ...
    int count, MPI_Datatype datatype, __D_MPI_REQUEST *request)
{
    ...
    tm1 = darshan_core_wtime();
    ret = __real_MPI_File_iread_at(fh, offset, buf, count,
        datatype, request);
    tm2 = darshan_core_wtime();
...
#ifdef HAVE_MPIIO_CONST
DARSHAN_PMPI_MAP(MPI_File_iwrite_at, int, (MPI_File fh, MPI_Offset offset, const void * buf,
    int count, MPI_Datatype datatype, __D_MPI_REQUEST *request),
...
int DARSHAN_DECL(MPI_File_iwrite_at)(MPI_File fh, MPI_Offset offset, const void * buf,
    int count, MPI_Datatype datatype, __D_MPI_REQUEST *request)
#else
DARSHAN_PMPI_MAP(MPI_File_iwrite_at, int, (MPI_File fh, MPI_Offset offset, void * buf,
    int count, MPI_Datatype datatype, __D_MPI_REQUEST *request),
        MPI_File_iwrite_at(fh, offset, buf, count, datatype, request))
...
#endif
{
    ...
    tm1 = darshan_core_wtime();
    ret = __real_MPI_File_iwrite_at(fh, offset, buf,
...
DARSHAN_PMPI_MAP(MPI_File_iread_shared, int, (MPI_File fh, void * buf, int count,
    MPI_Datatype datatype, __D_MPI_REQUEST * request),
    ...
    MPI_Datatype datatype, __D_MPI_REQUEST * request)
{
    ...
    tm1 = darshan_core_wtime();
    ret = __real_MPI_File_iread_shared(fh, buf, count,
        datatype, request);
    tm2 = darshan_core_wtime();
...
#ifdef HAVE_MPIIO_CONST
DARSHAN_PMPI_MAP(MPI_File_iwrite_shared, int, (MPI_File fh, const void * buf, int count,
    MPI_Datatype datatype, __D_MPI_REQUEST * request),
...
int DARSHAN_DECL(MPI_File_iwrite_shared)(MPI_File fh, const void * buf, int count,
    MPI_Datatype datatype, __D_MPI_REQUEST * request)
#else
DARSHAN_PMPI_MAP(MPI_File_iwrite_shared, int, (MPI_File fh, void * buf, int count,
    MPI_Datatype datatype, __D_MPI_REQUEST * request),
        MPI_File_iwrite_shared(fh, buf, count, datatype, request))
...
#endif
{
    ...
    tm1 = darshan_core_wtime();
    ret = __real_MPI_File_iwrite_shared(fh, buf, count,
        datatype, request);
    tm2 = darshan_core_wtime();
...
DARSHAN_PMPI_MAP(MPI_File_sync, int, (MPI_File fh), MPI_File_sync(fh))
...
#ifdef HAVE_MPIIO_CONST
DARSHAN_PMPI_MAP(MPI_File_set_view, int, (MPI_File fh, MPI_Offset disp, MPI_Datatype etype,
...
#endif
{
    ...
    MAP_OR_FAIL(MPI_File_set_view);

    tm1 = darshan_core_wtime();
    ret = __real_MPI_File_set_view(fh, disp, etype, filetype,
        datarep, info);
    tm2 = darshan_core_wtime();
...
DARSHAN_PMPI_MAP(MPI_File_close, int, (MPI_File *fh), MPI_File_close(fh))
