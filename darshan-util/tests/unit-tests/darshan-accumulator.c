...
static void stdio_validate_double_dummy_record(void* buffer, int shared_file_flag);
static void mpiio_set_dummy_record(void* buffer);
static void mpiio_validate_double_dummy_record(void* buffer, int shared_file_flag);
...
void (*validate_double_dummy_fn[DARSHAN_KNOWN_MODULE_COUNT])(void*, int) = {
    NULL, /* DARSHAN_NULL_MOD */
